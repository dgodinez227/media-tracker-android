    ...
    Column {
        ...
        Column(
            ...
            Spacer(Modifier.height(16.dp))
                ...
                Text(
                    text = fakeMedia.author ?: fakeMedia.director ?: "Unknown",
                ...
                Row(
                    ...
                    Text(
                        text = buildString {
                            append(" ${String.format("%.1f", fakeMedia.averageRating)}")
                            append(" • ${fakeMedia.mediaType.replaceFirstChar { it.uppercase() }}")
                            fakeMedia.publishedYear?.let { append(" • $it") }
                        },
