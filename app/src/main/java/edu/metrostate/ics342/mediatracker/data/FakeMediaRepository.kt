...
object FakeMediaRepository {
    ...
    val mediaList = listOf(
        ...
        Media(
            id = 7,  mediaType = MediaType.MOVIE, title = "Interstellar",
            director = "Christopher Nolan", publishedYear = 2014,
            averageRating = 4.6f, ratingCount = 441,
            description = "",
            genres = listOf("Science Fiction", "Adventure")),
        Media(
            id = 8,  mediaType = MediaType.SHOW,  title = "Severance",
        ...
        Media(
            id = 9,  mediaType = MediaType.SHOW, title = "The Bear",
        ...
        Media(
            id = 10, mediaType = MediaType.SHOW,  title = "Andor",
